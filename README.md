...
2. Base32hex encoding is REQUIRED for case-insensitive use or with a limited set of characters to ensure compatibility, or for typing, writing, or dictation of UUIDs.﻿
3. The standard 36-character hexadecimal format is REQUIRED if neither Base64UUID nor Base32hex encoding is feasible.
