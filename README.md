...
The `$` character in Base64UUID strings MUST be permitted without percent-encoding by relevant URL parsing and generation systems. This ensures Base64UUID encoding meets URL safety requirements.
