...
3. Prepend the 4-bit prefix `0100` (binary) as the most significant bits to the entire 128-bit UUID, forming a 132-bit value. This prefix ensures the encoded string starts with a letter.
